...
describe('ChatMessage', () => {
  test('renders user message correctly', () => {
    ...
    expect(screen.getByText('Hello, this is a test').parentNode?.parentNode).toHaveClass('user-message');
  ...
  test('renders bot message correctly', () => {
    ...
    expect(screen.getByText('I am an AI assistant').parentNode?.parentNode).toHaveClass('bot-message');
  });
