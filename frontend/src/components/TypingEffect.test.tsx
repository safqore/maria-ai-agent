...
describe('TypingEffect Component', () => {
  ...
  test('renders without crashing', () => {
    render(<TypingEffect message="Test message" onTypingComplete={mockTypingComplete} />);

    expect(screen.getByTestId('typing-effect')).toBeInTheDocument();
  });

  test('types message character by character', () => {
    render(<TypingEffect message="Hello" onTypingComplete={mockTypingComplete} typingSpeed={10} />);
  ...
  test('calls onTypingComplete when finished typing', () => {
    render(<TypingEffect message="Test" onTypingComplete={mockTypingComplete} typingSpeed={10} />);
  ...
  test('handles empty message gracefully', () => {
    render(<TypingEffect message="" onTypingComplete={mockTypingComplete} />);
