...
class TestEmailService:
    ...
    def test_create_email_template_development_environment(self):
        ...
        code = "654321"
        subject, html_content = self.email_service.create_email_template(code, "development")
    ...
    def test_create_email_template_production_environment(self):
        ...
        code = "789012"
        subject, html_content = self.email_service.create_email_template(code, "production")
