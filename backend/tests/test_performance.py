...
class TestPerformance:
    ...
    def test_repository_create_performance(self):
        ...
        assert avg_time < 0.2, f"Average create time {avg_time:.3f}s exceeds 200ms threshold"
        assert max_time < 0.5, f"Max create time {max_time:.3f}s exceeds 500ms threshold"
    ...
    def test_repository_get_performance(self):
        ...
        assert avg_time < 0.1, f"Average get time {avg_time:.3f}s exceeds 100ms threshold"
    ...
    def test_connection_pooling_performance(self):
        ...
        assert avg_time < 0.1, f"Average connection time {avg_time:.3f}s suggests pooling issues"
        assert max_time < 0.2, f"Max connection time {max_time:.3f}s suggests pooling issues"
    ...
    def test_transaction_context_performance(self):
        ...
        assert avg_time < 0.2, f"Average transaction time {avg_time:.3f}s exceeds 200ms threshold"
        assert max_time < 0.5, f"Max transaction time {max_time:.3f}s exceeds 500ms threshold"
